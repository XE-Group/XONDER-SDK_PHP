...
class Gateway {
	 ...
	 */
	static public $hostedUrl = 'https://payments.xonder.net/hosted/';

	/**
	 * @var string	Gateway Direct API Endpoint
	 */
	static public $directUrl = 'https://payments.xonder.net/direct/';

	/**
	 * @var string	Merchant Account Id or Alias
	 */
	static public $merchantID = '123521';
	 ...
	 */
	static public $merchantSecret = 'LzcQi4tcN5xd';
